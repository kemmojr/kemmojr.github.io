...
/** @type {string} */
const CACHE_VERSION = '1738236586|2285712750';
/** @type {string} */
const CACHE_PREFIX = 'Snake_game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Snake_game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Snake_game.html","Snake_game.js","Snake_game.offline.html","Snake_game.icon.png","Snake_game.apple-touch-icon.png","Snake_game.worker.js","Snake_game.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Snake_game.wasm","Snake_game.pck"];
